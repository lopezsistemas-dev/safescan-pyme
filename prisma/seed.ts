...
async function main() {
  ...
  const caso1 = await prisma.analysis.create({
    data: {
      ...
      sha256: "64e26e310e478149313b5420433e379d513383f1f6da34b5c562b0cafd32d4d8",
      ...
      adminReport: [
        ...
        "",
        "- **SHA-256:** 64e26e310e478149313b5420433e379d513383f1f6da34b5c562b0cafd32d4d8",
        ...
        "- **Threat Score:** 100/100 · **Sensitivity Score:** 18/100",
        "- **Flujo aplicado:** QUARANTINE (política: bloquear ejecutables).",
        "- **Proveedor:** simulación VirusTotal (modo mock del MVP). 45/70 motores marcarían este patrón como malicioso según el modelo de simulación.",
      ...
      tiJson: JSON.stringify({
        ...
        reputation: -60,
        matchedThreats: [
          "Mal/DoubleExt-A (simulado)",
          "Trojan.GenericKD (simulado)",
          "Archive.Suspicious.Payload (simulado)",
        ],
  ...
  await prisma.indicator.createMany({
    data: [
      ...
      { analysisId: caso1.id, type: "HASH", value: "64e26e31…fd32d4d8 (SHA-256)", risk: "ALTO" },
  ...
  await prisma.auditLog.createMany({
    data: [
      ...
      { tenantId: asesoria.id, userId: pablo.id, analysisId: caso1.id, action: "ANALISIS_COMPLETADO", details: "Veredicto BLOQUEAR (threat 100, sensibilidad 18). Flujo QUARANTINE.", createdAt: hoursAgo(70) },
